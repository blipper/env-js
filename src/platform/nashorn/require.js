var __this__ = this;
var print = function (msg) {java.lang.System.out.println(msg);};
var require = (function() {
    var cached = {};
    //var currentPath = java.lang.System.getProperty('user.dir');
    var currentPath = '/usr/local/tmc/git/env-js';
    ...
    function require(id) {
        ...
        if (!cached.hasOwnProperty(id)) {
            ...
            try {
                ...
                var func = load({ script: source, name: id});
...
require('envjs/platform/nashorn');
